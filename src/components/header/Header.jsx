    ...
    <header className="container">
      ...
      <div className="search">
        <div>
          ...
          <input value={pizzaName} onChange={onChange} type="text" placeholder="Поиск..." className="text-xl" />
        </div>
      </div>
      <div className="buttons">
        <Link to="/cart">
          <button className="button flex">
            <span className="icon"><HiOutlineShoppingCart className='text-xl' /></span>&nbsp;&nbsp;
            <span>0 $</span>&nbsp;&nbsp; | &nbsp;&nbsp;
            <span>{cart.length}</span>
          </button>
        </Link>
        <button className="button flex">
          <span className="icon"><HiOutlineUser   className='text-xl'/></span>
          Личный кабинет
        </button>
      </div>
    </header>
